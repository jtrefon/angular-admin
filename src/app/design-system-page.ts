...
export class DesignSystemPageComponent {
  ...
  protected readonly activity: ActivityFeedItem[] = [
  ...
  protected readonly sectionIntro = computed(() => {
    const intros = {
      overview: {
        ...
        description:
          'A route-driven admin design system with reusable widgets, operational cards, chart modules, forms, and data-heavy components.',
      },
      foundations: {
        eyebrow: 'Foundations',
        title: 'Type, color, spacing, radius, and surface tokens',
        description:
          'The visual grammar for the backoffice system, presented in a denser, more conventional layout.',
      },
      navigation: {
        eyebrow: 'Navigation',
        title: 'Shell navigation, menus, tabs, and context rails',
        description:
          'Reusable navigation components for documentation-style backoffice surfaces and workspace shells.',
      },
      forms: {
        eyebrow: 'Forms',
        title: 'Advanced admin forms and input controls',
        description:
          'Dense, production-oriented form patterns with grouped controls, switches, summaries, and stateful actions.',
      },
      charts: {
        eyebrow: 'Charts',
        title: 'Visualization components for admin analytics surfaces',
        description:
          'Denser chart cards and widgets for KPIs, workload trends, health metrics, and dashboard analytics.',
      },
      data: {
        eyebrow: 'Data tables',
        title: 'Interactive smart table and record management patterns',
        description:
          'Search, typeahead, filtering, sorting, pagination, and supporting widgets designed for backoffice records.',
      },
      feedback: {
        eyebrow: 'Feedback',
        title: 'Status, alert, loading, and system feedback components',
        description:
          'Communicate progress, state, exceptions, and collaboration context without overwhelming the interface.',
      },
      patterns: {
        eyebrow: 'Patterns',
        title: 'Workflow modules, cards, widgets, and operational templates',
        description:
          'Higher-level compositions that mirror what teams expect in admin systems like ngx-admin style dashboards.',
      },
    } as const;
